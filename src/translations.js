const translations = {
  en: {
    ...
    rxImageLabel: 'Prescription Image',
    rxImageHint: 'Upload a photo of your prescription (optional)',
    rxImageDrop: 'Click to upload or drag & drop',
    rxImageFormats: 'JPG, PNG or PDF · Max 5 MB',
    rxImageChange: 'Change image',
    rxImageRemove: 'Remove',
    allergiesLabel: 'Known Drug Allergies',
    conditionsLabel: 'Current Medical Conditions',
    allergiesSection: 'Allergies & Conditions',
    ...
    delivHint: 'Deliveries begin within 2–3 business days of approval.',
  ...
  ne: {
    ...
    heroTitle2: 'सावधानीपूर्वक डेलिभर गरिन्छ।',
    heroSubtitle: 'केही मिनेटमा सदस्यता सेटअप गर्नुहोस्। हामी रिफिल सम्हाल्छौं, तपाईं आफ्नो स्वास्थ्यमा ध्यान दिनुहोस्।',
    pill1: 'निःशुल्क एउटै दिनको डेलिभरी',
    pill2: 'सुरक्षित र इन्क्रिप्टेड',
    pill3: 'स्वत: रिफिल रिमाइन्डर',
    pill4: 'फार्मासिस्ट सहयोग',
    ...
    rxImageRemove: 'हटाउनुहोस्',
    allergiesLabel: 'थाहा भएको औषधि एलर्जी',
    conditionsLabel: 'हालको चिकित्सा अवस्था',
    allergiesSection: 'एलर्जी र अवस्थाहरू',
    ...
    firstDelivery: 'पहिलो डेलिभरी मिति',
    delivHint: 'स्वीकृतिको २–३ कार्य दिनभित्र डेलिभरी सुरु हुन्छ।',
    noPreference: 'कुनै प्राथमिकता छैन',
    morning: 'बिहान (८ बजे – १२ बजे)',
    afternoon: 'दिउँसो (१२ बजे – ५ बजे)',
    evening: 'साँझ (५ बजे – ८ बजे)',

    // Review
    reviewPersonal: 'व्यक्तिगत जानकारी',
    reviewMedications: 'औषधिहरू',
    reviewDoctor: 'डाक्टर र फार्मेसी',
    reviewDelivery: 'डेलिभरी',
    fullName: 'पूरा नाम',
    ...
    back: 'पछाडि',
    edit: 'सम्पादन',
    reviewOrder: 'अर्डर समीक्षा',
    confirmSubscription: 'सदस्यता पुष्टि गर्नुहोस्',
    step: 'चरण',
    of: 'मध्ये',
    ...
    // Frequency options
    freqOnce: 'दिनमा एक पटक',
    freqTwice: 'दिनमा दुई पटक',
    freqThrice: 'दिनमा तीन पटक',
    freqAlt: 'एक दिन छोडेर',
    freqWeekly: 'साप्ताहिक',
    freqAsNeeded: 'आवश्यकता अनुसार',

    // Success
    successTitle: 'तपाईं तयार हुनुभयो!',
